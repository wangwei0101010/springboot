package com.breakyizhan.web.common.ftl;
...
public class FreeMarkerForJava {
	...
	//项目名
	private static String workName = "creditdbapi";
	//实体类名称 首字母大写
	private static String modelName="ResourceModel";
	//创建人
	private static String author="qimy";
	//API描述
	private static String apiDescription="双公示查询";
	//选择采用的模板
	...
	//工作空间地址
    private static String URL = "E:\\gcx\\workspace_gcx\\" + workName + "\\src\\main\\java\\com\\breakyizhan\\web";
