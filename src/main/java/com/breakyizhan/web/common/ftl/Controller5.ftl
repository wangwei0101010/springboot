...
import com.breakyizhan.web.common.base.BaseController;
import com.breakyizhan.web.common.validator.ValidatorUtils;
import com.breakyizhan.web.common.validator.groups.MajorKey;
import com.breakyizhan.web.common.util.MyResult;
import com.breakyizhan.web.model.${param1};
import com.breakyizhan.web.service.${param1}Service;
