package com.breakyizhan.web.common.spring;//package com.gcx.api.common.spring;
//
...
//
//	@Before("execution(* com.gcx.api.controller.ResourceAllController.findAllRecords(..))")
